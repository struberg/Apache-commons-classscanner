...
public class ClassScannerTest {
    ...
    public void testClassScanner() throws Exception {
        ...
        Map<String, Set<String>> classIndex = cs.getClassesIndex(MockClassScannerClient.NAME);
        Assert.assertNotNull(classIndex);
        Assert.assertEquals(0, classIndex.size());

        Assert.assertTrue(cs instanceof MockClassScanner);
    }
}
